...
public interface PaperQuestionRepository extends JpaRepository<PaperQuestion, Integer> {
	...
	public Integer deleteQuestionByQuestionNo(@Param("paperId") Integer paperId,
	...
	public Integer addExtraAnswers(@Param("paperId") Integer paperId, @Param("questionNo") Integer questionNo,
