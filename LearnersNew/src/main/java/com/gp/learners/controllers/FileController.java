...
public class FileController {
	...
	/*
	 * Download Files type --> 1 = UserProfileImage type --> 2 = PDF type --> 3 =
	 * Package's Image
	 */
...
//	}
	...
	/*
	 * Upload file type --> 1 = UserProfileImage type --> 2 = PDF
	 */
	@PostMapping("file/upload/{id}/{type}")
	public ResponseEntity<Integer> uploadMultipartFile(@RequestParam("file") MultipartFile file,
