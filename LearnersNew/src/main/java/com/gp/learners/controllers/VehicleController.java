...
public class VehicleController {
	...
	public ResponseEntity<List<InsurancePayment>> getVehicleInsurancePaymentDetails(
	...
	public ResponseEntity<Integer> addInsurancePayment(@PathVariable("vehicleId") Integer vehicleId,
			@RequestBody InsurancePayment object) {
	...
	public ResponseEntity<Void> addVehicleFuelData(@PathVariable("userId") Integer userId,
			@RequestBody FuelPayment object) {
